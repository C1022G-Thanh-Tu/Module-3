...
create table hop_dong_chi_tiet (
    ...
    constraint fk_hop_dong_chi_tiet_ma_dich_vu_di_kem foreign key (ma_dich_vu_di_kem) references dich_vu_di_kem (ma_dich_vu_di_kem),
    constraint fk_hop_dong_chi_tiet_ma_hop_dong foreign key (ma_hop_dong) references hop_dong (ma_hop_dong)
);
