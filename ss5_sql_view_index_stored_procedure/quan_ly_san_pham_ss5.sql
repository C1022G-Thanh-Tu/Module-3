...
where product_code = 'mt';
explain select * from products 
where product_name = 'máy tính';
explain select * from products 
where product_price = '1002039';

-- Bước 4
create view view_products(product_code_view, product_name_view, product_price_view, product_status_view) as 
select product_code, product_name, product_price, product_status from products;
select * from view_products;
set sql_safe_updates = 0;
update view_products
set product_status_view = 'second hand'
where product_code_view = 'mt';
